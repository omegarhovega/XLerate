...
3. Navigate through dependencies using the `up` and `down` arrow keys to navigate, and the `left` and `right` arrow keys to open deeper levels of dependencies in the interactive dialog box
